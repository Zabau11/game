...
const FLOAT_CARDS: FloatCardDef[] = [
  {
    prompt: "Best rainy day plan?",
    pos: { top: "41%", left: "24%" },
    rot: "-1deg", width: 190, opacity: 0.22,
    bars: [
      { label: "Movie", pct: 71, winner: true },
      { label: "Walk", pct: 20 },
      { label: "Cafe", pct: 9 },
    ],
  },
  {
    prompt: "Most trusted guide?",
    pos: { top: "14%", left: "4%" },
    rot: "-3deg", width: 208, opacity: 0.30,
    bars: [
      { label: "Map", pct: 67, winner: true },
      { label: "Compass", pct: 21 },
      { label: "Stars", pct: 12 },
    ],
  },
  {
    prompt: "Pick the coziest?",
    pos: { top: "13%", left: "61%" },
    rot: "2.5deg", width: 194, opacity: 0.28,
    pills: [
      { label: "Blanket", winner: true },
      { label: "Lamp" },
    ],
  },
  {
    prompt: "Fastest city ride?",
    pos: { top: "75%", left: "7%" },
    rot: "-2deg", width: 214, opacity: 0.26,
    mobileHide: true,
    bars: [
      { label: "Metro", pct: 58, winner: true },
      { label: "Bike", pct: 28 },
      { label: "Taxi", pct: 14 },
    ],
  },
  {
    prompt: "Best desk snack?",
    pos: { top: "75%", left: "63%" },
    rot: "-1.5deg", width: 198, opacity: 0.24,
    mobileHide: true,
    bars: [
      { label: "Nuts", pct: 52, winner: true },
      { label: "Fruit", pct: 31 },
      { label: "Chips", pct: 17 },
    ],
  },
  {
    prompt: "Vacation signal?",
    pos: { top: "44%", left: "73%" },
    rot: "1deg", width: 190, opacity: 0.28,
    mobileHide: true,
    bars: [
      { label: "Beach", pct: 44, winner: true },
      { label: "City", pct: 35 },
      { label: "Cabin", pct: 21 },
    ],
  },
